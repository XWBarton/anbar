...
export default function SetupPage() {
  ...
  return (
    ...
    >
      <Card style={{ width: 460, boxShadow: '0 8px 40px rgba(140,47,57,0.15)', borderRadius: 12 }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          <div className="brand-title" style={{ fontSize: 32, color: '#8C2F39', marginBottom: 6, lineHeight: 1.1 }}>
            anbār
          </div>
