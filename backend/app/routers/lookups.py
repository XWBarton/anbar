...
from ..crud.lookup_option import create_option, delete_option, get_option, get_options
...
def list_options(category: str, db: Session = Depends(get_db), _: User = Depends(get_current_user)):
